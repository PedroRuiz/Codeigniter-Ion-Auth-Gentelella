...
<html lang="en">
  <head>
    ...
    <title>Gentelella Alela! | <?php echo lang('edit_user_heading');?></title>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <div class="alert alert-danger alert-dismissible fade in" role="alert">
                        <strong>Mind the messages!</strong> <?php echo $message;?>
                      </div>
                      <?php endif;?>
                      ...
                      <?php if ($this->ion_auth->is_admin()): ?>
                          ...
                          <?php foreach ($groups as $group):?>
                              ...
                              ?>
                                  ...
                                  <label>
                                      <input type="checkbox" name="groups[]" value="<?php echo $group['id'];?>"<?php echo $checked;?>> <?php echo htmlspecialchars($group['name'],ENT_QUOTES,'UTF-8');?>
                                  </label>
                              </div>
                    ...
                    (Mind if your browser presents passwords, delete it for save if you don't need change it!)
                  </div>
                </div>
              </div>
            </div>
